...
export const SIX_FORMS_OVERVIEW = [
  ...
  { form: "命令形" as VerbForm, desc: "命令して終わる", acc: "助動詞接続なし", detail: "相手に命令して文を終える形。後ろに助動詞は接続しない。この形だけで文が完結する。命令だけでなく「どうにでもなれ」という放任の気持ちも表す（放任法）。例:「いづくにもあれ（どこでもよい）」。", example: "書け！（書け）" },
] as const;
